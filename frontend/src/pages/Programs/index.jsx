		...
		<section className="py-20 bg-gray-50 min-h-screen">
			<div className="max-w-7xl mx-auto px-4">
				...
				<div className="mb-12">
					...
					<h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4 flex items-center gap-3">
						<BookOpen size={48} className="text-[#EE048B]" />
						...
						<div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
							...
							{(filters.search ||
								...
								<button
									...
									{i18n.language === "sw" ? "Ondoa Chuja" : "Clear All Filters"}
								</button>
							)}
						</div>
